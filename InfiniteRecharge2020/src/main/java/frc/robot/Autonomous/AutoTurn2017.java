 ...
 * 
 */
public class AutoTurn2017 extends Command {
    ...
    public AutoTurn2017(double angle, boolean inAuto, boolean autoTarget) {
...
//    	Robot.drivebase.recalibrateGyro(); 
    ...
    protected void execute() {
    	...
    	currentAngle = Robot.drivebase.getGyroAngle() - initAngle;
    	}
