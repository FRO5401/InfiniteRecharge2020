...
public class Shooter extends SubsystemBase {
    ...
    WPI_TalonFX shooterMaster, shooterSlave;
    ...
    public Shooter() {
        ...
        // Placeholder
        shooterMaster = new WPI_TalonFX(RobotMap.SHOOTER_MASTER_CHANNEL); //TODO: Set to correct CAN IDs
        shooterSlave = new WPI_TalonFX(RobotMap.SHOOTER_SLAVE_CHANNEL);
